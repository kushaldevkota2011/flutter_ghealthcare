...
final codeConcept = CodeableConcept(coding: [
  Coding(
      system: FhirUri(
...
final extensionFromRace = {
  ...
  PatientUsCoreRace.other_race: FhirExtension(
      url: FhirUri('ombCategory'),
      valueCoding: Coding(
        system: FhirUri('urn:oid:2.16.840.1.113883.6.238'),
        code: Code('2131-1'),
...
final extensionFromRace2 = {
  PatientUsCoreRace.american_indian_or_alaska_native: RUsCoreRace(
  ...
  PatientUsCoreRace.asian: RUsCoreRace(
    text: "Asian",
    ombCategory: [
      Coding(
        system: FhirUri('urn:oid:2.16.840.1.113883.6.238'),
  ...
  PatientUsCoreRace.black_or_african_american: RUsCoreRace(
  ...
  PatientUsCoreRace.native_hawaiian_or_other_pacific_islander: RUsCoreRace(
  ...
  PatientUsCoreRace.white: RUsCoreRace(
    text: "white",
    ombCategory: [
      Coding(
        system: FhirUri('urn:oid:2.16.840.1.113883.6.238'),
  ...
  PatientUsCoreRace.other_race: RUsCoreRace(
    text: "white",
    ombCategory: [
      Coding(
        system: FhirUri('urn:oid:2.16.840.1.113883.6.238'),
  ...
  PatientUsCoreRace.unknown: RUsCoreRace(
    text: "Unknown",
    ombCategory: [
      Coding(
        system: FhirUri('http://terminology.hl7.org/CodeSystem/v3-NullFlavor'),
  ...
  PatientUsCoreRace.asked_but_no_answer: RUsCoreRace(
    text: "Asked but no answer",
    ombCategory: [
      Coding(
        system: FhirUri('http://terminology.hl7.org/CodeSystem/v3-NullFlavor'),
        code: Code('ASKU'),
...
final extensionFromEthnicity2 = {
  PatientUsCoreEthnicity.hispanic_or_latino: RUsCoreEthnicity(
  ...
  PatientUsCoreEthnicity.non_hispanic_or_latino: RUsCoreEthnicity(
...
final extensionFromBirthSex = {
  ...
  PatientUsCoreBirthSex.unknown: FhirExtension(
      url: FhirUri(
          'http://hl7.org/fhir/us/core/StructureDefinition/us-core-birthsex'),
      valueCode: Code('UNK')),
  PatientUsCoreBirthSex.asked_but_unknown: FhirExtension(
      url: FhirUri(
          'http://hl7.org/fhir/us/core/StructureDefinition/us-core-birthsex'),
      valueCode: Code('ASKU')),
  PatientUsCoreBirthSex.other: FhirExtension(
      url: FhirUri(
          'http://hl7.org/fhir/us/core/StructureDefinition/us-core-birthsex'),
      valueCode: Code('OTH')),
};

final extensionFromBirthSex2 = {
  PatientUsCoreBirthSex.female: 'F',
  PatientUsCoreBirthSex.male: 'M',
  PatientUsCoreBirthSex.unknown: 'UNK',
  PatientUsCoreBirthSex.asked_but_unknown: 'ASKU',
  PatientUsCoreBirthSex.other: 'OTH',
};

enum PatientUsCoreGenderIdentity {
  @JsonValue('transgender female')
  transgender_female,
  @JsonValue('transgender male')
  transgender_male,
  ...
  female,
  other,
  @JsonValue('non-disclose')
  does_not_wish_to_disclose
}

final extensionFromGenderIdentity = {
  PatientUsCoreGenderIdentity.transgender_female: FhirExtension(
    valueCode: Code('transgender-female'),
    url: FhirUri('http://hl7.org/fhir/R4/codesystem-gender-identity.html'),
  ),
  PatientUsCoreGenderIdentity.transgender_male: FhirExtension(
    valueCode: Code('transgender-male'),
    url: FhirUri('http://hl7.org/fhir/R4/codesystem-gender-identity.html'),
  ),
  PatientUsCoreGenderIdentity.non_binary: FhirExtension(
    valueCode: Code('non-binary'),
    url: FhirUri('http://hl7.org/fhir/R4/codesystem-gender-identity.html'),
  ),
  PatientUsCoreGenderIdentity.male: FhirExtension(
    valueCode: Code('ale'),
    url: FhirUri('http://hl7.org/fhir/R4/codesystem-gender-identity.html'),
  ),
  PatientUsCoreGenderIdentity.female: FhirExtension(
    valueCode: Code('female'),
    url: FhirUri('http://hl7.org/fhir/R4/codesystem-gender-identity.html'),
  ),
  PatientUsCoreGenderIdentity.other: FhirExtension(
    valueCode: Code('other'),
    url: FhirUri('http://hl7.org/fhir/R4/codesystem-gender-identity.html'),
  ),
  PatientUsCoreGenderIdentity.does_not_wish_to_disclose: FhirExtension(
    valueCode: Code('non-disclose'),
    url: FhirUri('http://hl7.org/fhir/R4/codesystem-gender-identity.html'),
  ),
};

enum PatientSexualOrientation {
  @JsonValue('Asexual Person')
  asexual_person,
  @JsonValue('Bisexual Person')
  bisexual_person,
  @JsonValue('Gay Person')
  gay_person,
  @JsonValue('Lesbian Person')
  lesbian_person,
  @JsonValue('Queer Person')
  queer_person,
  @JsonValue('Quationin Person')
  quationin_person,
  @JsonValue('Strignt Person')
  straight_persion,
  @JsonValue('Something Else')
  someting_else,
  @JsonValue('Multiple Sexual')
  multiple_sexual,
  @JsonValue('Decline To')
  decline_to,
  @JsonValue('No Informations')
  no_information,
  @JsonValue('Unknown Persons')
  unknown_persons,
  @JsonValue('Other Persons')
  other_persons,
}

final extensionFromSexualOrientation = {
  PatientSexualOrientation.asexual_person: FhirExtension(
    valueCode: Code('AS'),
    url: FhirUri(
        'https://build.fhir.org/ig/HL7/cdmh/CodeSystem-pcornet-sexual-orientation.html'),
  ),
  PatientSexualOrientation.bisexual_person: FhirExtension(
    valueCode: Code('BI'),
    url: FhirUri(
        'https://build.fhir.org/ig/HL7/cdmh/CodeSystem-pcornet-sexual-orientation.html'),
  ),
  PatientSexualOrientation.gay_person: FhirExtension(
    valueCode: Code('GA'),
    url: FhirUri(
        'https://build.fhir.org/ig/HL7/cdmh/CodeSystem-pcornet-sexual-orientation.html'),
  ),
  PatientSexualOrientation.lesbian_person: FhirExtension(
    valueCode: Code('LE'),
    url: FhirUri(
        'https://build.fhir.org/ig/HL7/cdmh/CodeSystem-pcornet-sexual-orientation.html'),
  ),
  PatientSexualOrientation.queer_person: FhirExtension(
    valueCode: Code('QU'),
    url: FhirUri(
        'https://build.fhir.org/ig/HL7/cdmh/CodeSystem-pcornet-sexual-orientation.html'),
  ),
  PatientSexualOrientation.quationin_person: FhirExtension(
    valueCode: Code('QS'),
    url: FhirUri(
        'https://build.fhir.org/ig/HL7/cdmh/CodeSystem-pcornet-sexual-orientation.html'),
  ),
  PatientSexualOrientation.straight_persion: FhirExtension(
    valueCode: Code('ST'),
    url: FhirUri(
        'https://build.fhir.org/ig/HL7/cdmh/CodeSystem-pcornet-sexual-orientation.html'),
  ),
  PatientSexualOrientation.someting_else: FhirExtension(
    valueCode: Code('SE'),
    url: FhirUri(
        'https://build.fhir.org/ig/HL7/cdmh/CodeSystem-pcornet-sexual-orientation.html'),
  ),
  PatientSexualOrientation.multiple_sexual: FhirExtension(
    valueCode: Code('MU'),
    url: FhirUri(
        'https://build.fhir.org/ig/HL7/cdmh/CodeSystem-pcornet-sexual-orientation.html'),
  ),
  PatientSexualOrientation.decline_to: FhirExtension(
    valueCode: Code('DC'),
    url: FhirUri(
        'https://build.fhir.org/ig/HL7/cdmh/CodeSystem-pcornet-sexual-orientation.html'),
  ),
  PatientSexualOrientation.no_information: FhirExtension(
    valueCode: Code('NI'),
    url: FhirUri(
        'https://build.fhir.org/ig/HL7/cdmh/CodeSystem-pcornet-sexual-orientation.html'),
  ),
  PatientSexualOrientation.unknown_persons: FhirExtension(
    valueCode: Code('UN'),
    url: FhirUri(
        'https://build.fhir.org/ig/HL7/cdmh/CodeSystem-pcornet-sexual-orientation.html'),
  ),
  PatientSexualOrientation.other_persons: FhirExtension(
    valueCode: Code('OT'),
    url: FhirUri(
        'https://build.fhir.org/ig/HL7/cdmh/CodeSystem-pcornet-sexual-orientation.html'),
  ),
